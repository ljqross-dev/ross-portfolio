// Ross的研习社 — 私域 · Instagram 数据
// 数据来源：https://www.instagram.com/ross.luo.35/
// 封面使用 Instagram CDN 原图，详情图含多图轮播。
// 分类：ui-design(UI设计) / brand-work(品牌作品) / ai-art(AI艺术) / daily-life(日常)
window.INSTAGRAM = {
  author: "ross.luo.35",
  profile: "https://www.instagram.com/ross.luo.35/",
  avatar: "images/ins-avatar.jpg",
  bio: "AI 驱动商业设计师 · 全栈电商视觉运营",
  categories: [
    { id: "all", label: "全部" },
    { id: "ui-design", label: "UI 设计" },
    { id: "brand-work", label: "品牌作品" },
    { id: "ai-art", label: "AI 艺术" },
    { id: "daily-life", label: "日常" }
  ],
  posts: [
    // ===== UI 设计 =====
    ...
    // ===== 品牌作品 =====
    { id: "i4", title: "Brand Visual Identity — Luo's Milk Tea", cat: "brand-work",
      cover: "images/ins-brand-1.jpg",
      link: "https://www.instagram.com/p/",
      likes: 234, comments: 31, date: "2026-04-18",
      images: ["images/ins-brand-1.jpg"] },

    { id: "i5", title: "E-commerce Visual — Summer Campaign KV", cat: "brand-work",
      cover: "images/ins-brand-2.jpg",
      link: "https://www.instagram.com/p/",
      likes: 178, comments: 19, date: "2026-03-22",
      images: ["images/ins-brand-2.jpg"] },
    ...
    // ===== 日常 =====
    { id: "i9", title: "Workspace Setup — Design Tools 2026", cat: "daily-life",
      cover: "images/ins-daily-1.jpg",
      link: "https://www.instagram.com/p/",
      likes: 145, comments: 22, date: "2025-11-20",
      images: ["images/ins-daily-1.jpg"] },

    { id: "i10", title: "Design Process Behind the Scenes", cat: "daily-life",
      cover: "images/ins-daily-2.jpg",
      link: "https://www.instagram.com/p/",
      likes: 98, comments: 14, date: "2025-10-08",
      images: ["images/ins-daily-2.jpg"] }
  ]
};
